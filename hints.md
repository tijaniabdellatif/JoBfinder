...
in the controller folder jobcontroller : create the function add

create the view we will use the form helper using Cakephp in the css file make some changes to the inputs and select

add() => test if the form is submitted
